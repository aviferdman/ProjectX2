      ...
      return [
        {
          id: taskId('developer'),
          agentId: 'developer',
          description: 'Pick the highest-priority `todo` task assigned to you from the backlog. Implement it in the product repository following coding conventions. Write meaningful commits. Mark the task as `review` when done.',
          dependencies: [],
        ...
        },
        {
          id: taskId('qa'),
          agentId: 'qa',
          description: 'Review tasks in `review` status. Write tests for completed features. Run the test suite. Report any bugs found. Mark tasks as `done` if they pass quality gates.',
        ...
        },
        {
          id: taskId('projm'),
          agentId: 'projm',
          description: 'Track sprint progress. Review completed and blocked tasks. Reassign or reprioritize as needed. If all P0/P1 tasks are done, recommend advancing to testing phase. Update project-status.md.',
        ...
        },
        {
          id: taskId('pm'),
          agentId: 'pm',
          description: 'Review product progress against feature goals. Validate that completed work meets acceptance criteria and product vision. Identify any scope gaps or new stories needed.',
          dependencies: [taskId('projm')],
          branchName: branchName('pm'),
        },
      ];
